...
- I am researcher working @ University of Rome "Tor Vergata" and I am interested in using ecological and molecular tools to inform conservation actions
...
events[c(8, 12, 15, 19, 22, 26, 29)] <- "Classes"
...
calendR(year = 2022, 
        ...
        legend.title = "",
        text = c("10:00-12:00", "16:00-18:00", "10:00-12:00", "16:00-18:00",
                 "10:00-12:00", "16:00-18:00", "10:00-12:00"),             
        text.pos = c(8, 12, 15, 19, 22, 26, 29),        
        text.size = 3.5,              
        text.col = "black")
```
...
calendR(year = 2022, 
        ...
        legend.pos = "bottom", # Legend position
        legend.title = "",
        text = c("16:00-18:00", "10:00-12:00"),             
        text.pos = c(3,6),        
        text.size = 3.5,              
        text.col = "black")
```
