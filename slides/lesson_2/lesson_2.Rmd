...
```{r exer_2, echo=TRUE, cache = TRUE, fig.align = 'center', fig.cap = '**Figure 14:** Basic plot of the dataset downloaded from movebank.'}
library(move)
...
```{r exer_3, echo=TRUE, fig.align = 'center', fig.cap = '**Figure 15:** A prettier image, but still not very informative for us.', message=FALSE, cache=TRUE}
library(ggmap)
